...
path_base <- "C:/Users/helen/Desktop/TFM/COREFLEETS VALERIA/HELENA/TAE/clean"
path_salida <- file.path(path_base, "Mapas_Flotas_TAE")
...
reg_fleets <- read.csv2("TAE_regional_fleets.csv")
acr_fleets <- read.csv2("TAE_acrossfleets.csv")
...
mapear_flota <- function(nombre_flota) {
  ...
  # Guardar
  ggsave(file.path(path_salida, paste0("Map_TAE_", nombre_flota, ".png")), 
